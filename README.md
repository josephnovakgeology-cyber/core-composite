core_composite.py is a python library that speeds up three major tasks in the analysis
of scientific drilling materials:
    
    1). Extraction of L*, a*, and b* values from legacy core images.
    
    2). Construction of composite sections with physical properties data.
